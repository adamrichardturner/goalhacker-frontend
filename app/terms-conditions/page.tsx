  ...
  return (
    <div className='max-w-4xl text-white min-h-screen mx-auto px-4 py-8'>
      ...
      <section className='mb-8'>
        ...
        <p className='mb-4'>
          Welcome to Goal Hacker. These terms and conditions outline the rules
          and regulations for the use of Goal Hacker, owned and operated by Adam
          Richard Turner (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;).
        </p>
      </section>
      ...
      <section className='mb-8'>
        ...
        <ul className='list-disc pl-6 mb-4 space-y-2'>
          ...
          <li>
            Goals and related data (titles, descriptions, progress tracking)
          </li>
      ...
      <section className='mb-8'>
        ...
        <p className='mb-4'>
          ...
          the purposes set out in these terms and conditions. We will retain and
      ...
      <section className='mb-8'>
        ...
        <p className='mb-4'>
          ...
          protecting against unauthorized or unlawful processing and against
      ...
      <section className='mb-8'>
        ...
        <p className='mb-4'>
          ...
          material changes to these terms, we will notify you through our
          service or by email prior to the changes becoming effective.
        </p>
      </section>
