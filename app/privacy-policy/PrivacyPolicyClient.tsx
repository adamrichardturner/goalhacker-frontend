  ...
  return (
    <div className="max-w-4xl min-h-screen mx-auto px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          At Goal Hacker, we take your privacy seriously. This Privacy Policy explains how we
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          The Data Controller for Goal Hacker is Adam Richard Turner. For any privacy-related
          inquiries, you can contact us at: [Contact details to be added]
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          ...
          <p className="mb-4">
            We use Google Analytics to help us understand how our service is used. Google Analytics
            may collect:
          </p>
          <ul className="list-disc pl-6 mb-4 space-y-2">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          We do not sell your personal data to third parties. Any third-party service providers we
          use are bound by contractual obligations to keep personal information confidential and use
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          You can exercise most of these rights directly through your account settings. You can
          delete your account and all associated data at any time through the Settings page. For any
          other requests regarding your rights, please contact us directly.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          collected it for. When you delete your account, all your personal data will be permanently
          deleted from our systems within 30 days, except where we are required to maintain certain
          records for legal or regulatory compliance.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          laws may differ from those in your jurisdiction. We ensure appropriate safeguards are in
          place for such transfers in accordance with applicable law.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          us at: [Contact details to be added]
        </p>
      </section>
