      ...
      <div className="flex flex-col gap-4">
        <div className="flex gap-2 pt-6">
          <div className="text-xs text-muted space-y-2">
            <h2 className="text-xl text-primary font-semibold">Step 5: Review and Customize</h2>
        ...
        <div className="space-y-6">
          <div className="bg-card rounded-lg p-6 space-y-4 border">
            <div className="grid gap-6 sm:gap-4">
              ...
              >
                <label className="text-sm font-medium text-primary cursor-pointer">Title</label>
                <p className="text-xs sm:text-sm text-muted-foreground">{goalData.title}</p>
              </div>
              ...
              <div
                ...
                className="cursor-pointer shadow sm:shadow-none hover:bg-accent/50 rounded-md p-2 -m-2 transition-colors"
              >
                <label className="text-sm font-medium text-primary cursor-pointer">Aims</label>
                <p className="text-xs sm:text-sm text-muted-foreground">{goalData.aims}</p>
              </div>
          ...
          <div className="bg-card rounded-lg p-6 space-y-4 border">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Choose an image that represents your goal and will keep you motivated.
              </p>
            </div>
        ...
        <div className="flex gap-2 pt-4">
          ...
          <Button onClick={onSubmit} disabled={isSubmitting} className="flex-1 h-12">
