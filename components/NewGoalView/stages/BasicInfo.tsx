...
export function BasicInfo({ onNext, updateGoalData, goalData, isLoading = false }: BasicInfoProps) {
  const handleNext = () => {
    if (goalData.title) {
      onNext()
    }
      ...
      <div className="flex flex-col gap-4">
        <div className="flex gap-2 pt-6">
          <div className="text-sm text-muted-foreground space-y-6 pb-6">
            <h2 className="text-xl text-primary font-semibold pb-2">Step 1: What is your goal?</h2>
            <div className="space-y-2">
              <p>
                Your goal should be defined clearly. It should be achievable, realistic and
                measurable.{' '}
              </p>
              <p>Focus on what you want to achieve, avoiding vague statements.</p>
              <p>
                For example, instead of saying &apos;Get healthy,&apos; say &apos;Exercise three
                times a week to improve fitness.&apos;
              </p>
            </div>
          </div>
        </div>
