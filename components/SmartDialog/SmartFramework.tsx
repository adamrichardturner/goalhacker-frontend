...
const smartDetails = [
  {
    ...
    example:
      'Instead of "Get fit", try "Run a 5K marathon in under 30 minutes"',
  },
  {
    letter: 'M',
    word: 'Measurable',
    ...
    example:
      'Track your running times, distance covered, and training frequency',
  },
  {
    letter: 'A',
    word: 'Achievable',
  ...
  },
  {
    ...
    word: 'Relevant',
    description:
      'Align with your broader objectives and current life situation.',
  ...
  },
  {
    ...
    word: 'Time-bound',
    description:
      'Set clear deadlines and milestones to create urgency and maintain focus.',
    ...
    <div className='space-y-6'>
      <div className='space-y-2'>
        ...
        <p className='text-muted-foreground'>
          Goal Hacker is built on the proven SMART goal-setting methodology,
          helping you transform vague aspirations into achievable outcomes.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Our platform seamlessly integrates the SMART framework into your
        ...
        <CardContent className='space-y-4'>
          <div className='space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>
              Our goal creation process guides you through each SMART criterion,
              ensuring your goals are well-defined and actionable.
            </p>
          </div>
          <div className='space-y-2'>
            <h4 className='font-medium'>Progress Tracking</h4>
            <p className='text-sm text-muted-foreground'>
              Built-in tracking tools help you measure progress against your
          ...
          <div className='space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>
              Break down larger goals into achievable subgoals, making complex
              objectives more manageable and trackable.
            </p>
          </div>
          <div className='space-y-2'>
            <h4 className='font-medium'>Timeline Management</h4>
            <p className='text-sm text-muted-foreground'>
              Set and track deadlines for both main goals and subgoals, keeping
